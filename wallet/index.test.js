...
describe('Wallet', () => {
  ...
  describe('calculating the balance', () => {
    ...
    describe('recepient conducts a transaction', () => {
      ...
      describe('sends another transaction to recepient', () => {
        beforeEach(() => {
          tp.clear();
          senderWallet.createTransaction(wallet.publicKey, addBalance, bc, tp);
          bc.addBlock(tp.transactions);
        ...
        it('calculates the recepient balance only using transactions since the recent one', () => {
